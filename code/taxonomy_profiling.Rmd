...
kraken <- read_tsv("h:/concrete_metagenome_test/data/kraken2_euk/S3_Fallen_brackenReport.txt", col_names = cols,trim_ws = F)
...
kraken_taxa_split <- kraken_otu %>% separate(taxonomy,into = c("kingdom","phylum","class","order","family","genus","species"),sep = "\\|")
